...
# instance fields
.field final synthetic clergy:Landroidx/paging/CachedPageEventFlow;
...
.method public constructor <init>(Landroidx/paging/CachedPageEventFlow;)V
    ...
    iput-object p1, p0, Landroidx/paging/CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1;->clergy:Landroidx/paging/CachedPageEventFlow;
...
.method public emit(Ljava/lang/Object;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Landroidx/paging/CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1$1;-><init>(Landroidx/paging/CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1;Lkotlin/coroutines/stylolite;)V
    ...
    .line 6
    iget-object p2, p0, Landroidx/paging/CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1;->clergy:Landroidx/paging/CachedPageEventFlow;

    invoke-static {p2}, Landroidx/paging/CachedPageEventFlow;->dispirit(Landroidx/paging/CachedPageEventFlow;)Lkotlinx/coroutines/flow/vidar;
    ...
    invoke-interface {p2, p1, v0}, Lkotlinx/coroutines/flow/vidar;->emit(Ljava/lang/Object;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    .line 7
    :goto_1
    iget-object p2, v2, Landroidx/paging/CachedPageEventFlow$job$1$invokeSuspend$$inlined$collect$1;->clergy:Landroidx/paging/CachedPageEventFlow;

    invoke-static {p2}, Landroidx/paging/CachedPageEventFlow;->stylolite(Landroidx/paging/CachedPageEventFlow;)Landroidx/paging/FlattenedPageController;
    ...
    invoke-virtual {p2, p1, v0}, Landroidx/paging/FlattenedPageController;->dispirit(Lkotlin/collections/IndexedValue;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
