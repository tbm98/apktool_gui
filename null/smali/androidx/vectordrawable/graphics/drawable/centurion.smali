.class public Landroidx/vectordrawable/graphics/drawable/centurion;
...
.method public static dispirit(Landroid/content/Context;I)Landroid/view/animation/Interpolator;
    .locals 4
    ...
    .line 3
    :try_start_0
    new-instance p0, Landroidx/interpolator/view/animation/poolside;

    invoke-direct {p0}, Landroidx/interpolator/view/animation/poolside;-><init>()V
    ...
    .line 4
    new-instance p0, Landroidx/interpolator/view/animation/dispirit;

    invoke-direct {p0}, Landroidx/interpolator/view/animation/dispirit;-><init>()V
    ...
    .line 5
    new-instance p0, Landroidx/interpolator/view/animation/stylolite;

    invoke-direct {p0}, Landroidx/interpolator/view/animation/stylolite;-><init>()V
    ...
    invoke-static {p0, v1, v3, v0}, Landroidx/vectordrawable/graphics/drawable/centurion;->poolside(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
...
.method private static poolside(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Interpolator;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 24
    new-instance v0, Landroidx/vectordrawable/graphics/drawable/ceilometer;

    invoke-direct {v0, p0, p2, p3}, Landroidx/vectordrawable/graphics/drawable/ceilometer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
