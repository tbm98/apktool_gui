...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;
    }
.end annotation
...
# instance fields
.field mAdapter:Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;

.field private mCallback:Landroidx/appcompat/view/menu/ecad$poolside;
...
.field mMenu:Landroidx/appcompat/view/menu/tori;
...
.method public getAdapter()Landroid/widget/ListAdapter;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mAdapter:Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;

    if-nez v0, :cond_0

    .line 2
    new-instance v0, Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;

    invoke-direct {v0, p0}, Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;-><init>(Landroidx/appcompat/view/menu/ListMenuPresenter;)V

    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mAdapter:Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;
...
.method public getMenuView(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/expiry;
    ...
    sget v1, Lstylolite/poolside$wary;->abc_expanded_menu_layout:I
    ...
    .line 3
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mAdapter:Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;

    if-nez p1, :cond_0

    .line 4
    new-instance p1, Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;

    invoke-direct {p1, p0}, Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;-><init>(Landroidx/appcompat/view/menu/ListMenuPresenter;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mAdapter:Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;
...
.method public initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/tori;)V
    ...
    :cond_1
    :goto_0
    iput-object p2, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mMenu:Landroidx/appcompat/view/menu/tori;
    ...
    .line 10
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;->notifyDataSetChanged()V
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/tori;Z)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mCallback:Landroidx/appcompat/view/menu/ecad$poolside;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mMenu:Landroidx/appcompat/view/menu/tori;

    iget-object p2, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mAdapter:Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;

    invoke-virtual {p2, p3}, Landroidx/appcompat/view/menu/ListMenuPresenter$poolside;->dispirit(I)Landroidx/appcompat/view/menu/homme;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p1, p2, p0, p3}, Landroidx/appcompat/view/menu/tori;->uppiled(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/ecad;I)Z
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/oxyphil;)Z
    ...
    .line 2
    :cond_0
    new-instance v0, Landroidx/appcompat/view/menu/deprecate;

    invoke-direct {v0, p1}, Landroidx/appcompat/view/menu/deprecate;-><init>(Landroidx/appcompat/view/menu/tori;)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/deprecate;->centurion(Landroid/os/IBinder;)V
...
.method public setCallback(Landroidx/appcompat/view/menu/ecad$poolside;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuPresenter;->mCallback:Landroidx/appcompat/view/menu/ecad$poolside;
