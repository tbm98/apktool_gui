...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/SwitchCompat$dispirit;
    }
.end annotation
...
.field private mEmojiCompatInitCallback:Landroidx/appcompat/widget/SwitchCompat$dispirit;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Landroidx/appcompat/widget/SwitchCompat$poolside;

    const-class v1, Ljava/lang/Float;

    const-string v2, "thumbPos"

    invoke-direct {v0, v1, v2}, Landroidx/appcompat/widget/SwitchCompat$poolside;-><init>(Ljava/lang/Class;Ljava/lang/String;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, Lstylolite/poolside$dispirit;->switchStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v2}, Landroidx/appcompat/widget/dromedary;->poolside(Landroid/view/View;Landroid/content/Context;)V
    ...
    .line 18
    sget-object v7, Lstylolite/poolside$expiry;->SwitchCompat:[I

    invoke-static {p1, p2, v7, p3, v1}, Landroidx/appcompat/widget/utilizable;->prostacyclin(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/utilizable;

    move-result-object v2

    .line 19
    invoke-virtual {v2}, Landroidx/appcompat/widget/utilizable;->ambury()Landroid/content/res/TypedArray;
    ...
    .line 21
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_android_thumb:I

    invoke-virtual {v2, v4}, Landroidx/appcompat/widget/utilizable;->homme(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 23
    :cond_0
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_track:I
    ...
    .line 25
    :cond_1
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_android_textOn:I

    invoke-virtual {v2, v4}, Landroidx/appcompat/widget/utilizable;->whydah(I)Ljava/lang/CharSequence;
    ...
    .line 26
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_android_textOff:I
    ...
    .line 27
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_showText:I

    invoke-virtual {v2, v4, v3}, Landroidx/appcompat/widget/utilizable;->poolside(IZ)Z
    ...
    .line 28
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v2, v4, v1}, Landroidx/appcompat/widget/utilizable;->ceilometer(II)I
    ...
    .line 29
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_switchMinWidth:I
    ...
    .line 30
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_switchPadding:I
    ...
    .line 31
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_splitTrack:I

    invoke-virtual {v2, v4, v1}, Landroidx/appcompat/widget/utilizable;->poolside(IZ)Z
    ...
    .line 32
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_thumbTint:I

    invoke-virtual {v2, v4}, Landroidx/appcompat/widget/utilizable;->centurion(I)Landroid/content/res/ColorStateList;
    ...
    .line 35
    :cond_2
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_thumbTintMode:I

    const/4 v5, -0x1

    .line 36
    invoke-virtual {v2, v4, v5}, Landroidx/appcompat/widget/utilizable;->phagocyte(II)I

    move-result v4

    .line 37
    invoke-static {v4, v0}, Landroidx/appcompat/widget/prostacyclin;->tori(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 43
    :cond_5
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_trackTint:I
    ...
    .line 46
    :cond_6
    sget v4, Lstylolite/poolside$expiry;->SwitchCompat_trackTintMode:I
    ...
    .line 54
    :cond_9
    sget v0, Lstylolite/poolside$expiry;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v2, v0, v1}, Landroidx/appcompat/widget/utilizable;->decadent(II)I
    ...
    .line 56
    :cond_a
    new-instance v0, Landroidx/appcompat/widget/metempirics;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/metempirics;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/metempirics;

    .line 57
    invoke-virtual {v0, p2, p3}, Landroidx/appcompat/widget/metempirics;->expiry(Landroid/util/AttributeSet;I)V

    .line 58
    invoke-virtual {v2}, Landroidx/appcompat/widget/utilizable;->credulity()V
    ...
    .line 62
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Landroidx/appcompat/widget/flocky;
...
.method private doTransformForOnOffText(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/flocky;->deprecate(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/flocky;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/flocky;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mAppCompatEmojiTextHelper:Landroidx/appcompat/widget/flocky;
...
.method private getThumbScrollRange()I
    ...
    .line 5
    invoke-static {v0}, Landroidx/appcompat/widget/prostacyclin;->centurion(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 6
    :cond_0
    sget-object v0, Landroidx/appcompat/widget/prostacyclin;->stylolite:Landroid/graphics/Rect;
...
.method private setOffStateDescriptionOnRAndAbove()V
    ...
    sget v1, Lstylolite/poolside$fuzzball;->abc_capital_off:I
...
.method private setOnStateDescriptionOnRAndAbove()V
    ...
    sget v1, Lstylolite/poolside$fuzzball;->abc_capital_on:I
...
.method private setupEmojiCompatLoadCallback()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/SwitchCompat$dispirit;
    ...
    .line 5
    :cond_1
    new-instance v1, Landroidx/appcompat/widget/SwitchCompat$dispirit;

    invoke-direct {v1, p0}, Landroidx/appcompat/widget/SwitchCompat$dispirit;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mEmojiCompatInitCallback:Landroidx/appcompat/widget/SwitchCompat$dispirit;

    .line 6
    invoke-virtual {v0, v1}, Landroidx/emoji2/text/tori;->whydah(Landroidx/emoji2/text/tori$tori;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 8
    invoke-static {v6}, Landroidx/appcompat/widget/prostacyclin;->centurion(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 9
    :cond_0
    sget-object v6, Landroidx/appcompat/widget/prostacyclin;->stylolite:Landroid/graphics/Rect;
    ...
    .line 24
    invoke-static {v0, v1, v2, v5, v4}, Landroidx/core/graphics/drawable/stylolite;->ecad(Landroid/graphics/drawable/Drawable;IIII)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 12
    invoke-static {v4}, Landroidx/appcompat/widget/prostacyclin;->centurion(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/prostacyclin;->centurion(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    .line 2
    sget p2, Lstylolite/poolside$expiry;->TextAppearance_android_textColor:I
    ...
    .line 5
    :goto_0
    sget p2, Lstylolite/poolside$expiry;->TextAppearance_android_textSize:I

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/utilizable;->ceilometer(II)I
    ...
    .line 9
    :cond_1
    sget p2, Lstylolite/poolside$expiry;->TextAppearance_android_typeface:I

    const/4 v1, -0x1

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/utilizable;->phagocyte(II)I

    move-result p2

    .line 10
    sget v2, Lstylolite/poolside$expiry;->TextAppearance_android_textStyle:I

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/utilizable;->phagocyte(II)I
    ...
    .line 12
    sget p2, Lstylolite/poolside$expiry;->TextAppearance_textAllCaps:I

    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/utilizable;->poolside(IZ)Z
    ...
    .line 13
    new-instance p2, Ldeprecate/poolside;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {p2, v0}, Ldeprecate/poolside;-><init>(Landroid/content/Context;)V
