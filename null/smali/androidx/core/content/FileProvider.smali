...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/core/content/FileProvider$dispirit;,
        Landroidx/core/content/FileProvider$stylolite;,
        Landroidx/core/content/FileProvider$poolside;
    }
.end annotation
...
.field private mStrategy:Landroidx/core/content/FileProvider$dispirit;
...
.method private static getPathStrategy(Landroid/content/Context;Ljava/lang/String;I)Landroidx/core/content/FileProvider$dispirit;
    .locals 2
    ...
    check-cast v1, Landroidx/core/content/FileProvider$dispirit;
    :try_end_0
    ...
    .line 3
    :try_start_1
    invoke-static {p0, p1, p2}, Landroidx/core/content/FileProvider;->parsePathStrategy(Landroid/content/Context;Ljava/lang/String;I)Landroidx/core/content/FileProvider$dispirit;
...
.method public static getUriForFile(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    ...
    .line 1
    invoke-static {p0, p1, v0}, Landroidx/core/content/FileProvider;->getPathStrategy(Landroid/content/Context;Ljava/lang/String;I)Landroidx/core/content/FileProvider$dispirit;

    move-result-object p0

    .line 2
    invoke-interface {p0, p2}, Landroidx/core/content/FileProvider$dispirit;->poolside(Ljava/io/File;)Landroid/net/Uri;
...
.method private static parsePathStrategy(Landroid/content/Context;Ljava/lang/String;I)Landroidx/core/content/FileProvider$dispirit;
    .locals 8
    ...
    .line 1
    new-instance v0, Landroidx/core/content/FileProvider$stylolite;

    invoke-direct {v0, p1}, Landroidx/core/content/FileProvider$stylolite;-><init>(Ljava/lang/String;)V
    ...
    .line 18
    invoke-static {p0, v2}, Landroidx/core/content/centurion;->getExternalFilesDirs(Landroid/content/Context;Ljava/lang/String;)[Ljava/io/File;
    ...
    .line 22
    invoke-static {p0}, Landroidx/core/content/centurion;->getExternalCacheDirs(Landroid/content/Context;)[Ljava/io/File;
    ...
    .line 27
    invoke-static {p0}, Landroidx/core/content/FileProvider$poolside;->poolside(Landroid/content/Context;)[Ljava/io/File;
    ...
    invoke-virtual {v0, v3, p2}, Landroidx/core/content/FileProvider$stylolite;->stylolite(Ljava/lang/String;Ljava/io/File;)V
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/core/content/FileProvider;->getPathStrategy(Landroid/content/Context;Ljava/lang/String;I)Landroidx/core/content/FileProvider$dispirit;

    move-result-object p1

    iput-object p1, p0, Landroidx/core/content/FileProvider;->mStrategy:Landroidx/core/content/FileProvider$dispirit;
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 1
    iget-object p2, p0, Landroidx/core/content/FileProvider;->mStrategy:Landroidx/core/content/FileProvider$dispirit;

    invoke-interface {p2, p1}, Landroidx/core/content/FileProvider$dispirit;->dispirit(Landroid/net/Uri;)Ljava/io/File;
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Landroidx/core/content/FileProvider;->mStrategy:Landroidx/core/content/FileProvider$dispirit;

    invoke-interface {v0, p1}, Landroidx/core/content/FileProvider$dispirit;->dispirit(Landroid/net/Uri;)Ljava/io/File;
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 1
    iget-object p3, p0, Landroidx/core/content/FileProvider;->mStrategy:Landroidx/core/content/FileProvider$dispirit;

    invoke-interface {p3, p1}, Landroidx/core/content/FileProvider$dispirit;->dispirit(Landroid/net/Uri;)Ljava/io/File;
