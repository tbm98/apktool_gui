...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->poolside(Landroid/app/Activity;)Lkotlinx/coroutines/flow/tori;
.end annotation
...
# direct methods
.method constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lkotlin/coroutines/stylolite;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static synthetic centurion(Lkotlinx/coroutines/channels/ceilometer;Landroidx/window/layout/rabi;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->tori(Lkotlinx/coroutines/channels/ceilometer;Landroidx/window/layout/rabi;)V

    return-void
.end method

.method private static final tori(Lkotlinx/coroutines/channels/ceilometer;Landroidx/window/layout/rabi;)V
    .locals 1
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/stylolite;)Lkotlin/coroutines/stylolite;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lkotlin/coroutines/stylolite;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lkotlinx/coroutines/flow/deprecate;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/flow/deprecate;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Lkotlin/coroutines/stylolite;)Lkotlin/coroutines/stylolite;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v4, Landroidx/core/util/centurion;
    ...
    .line 5
    invoke-static {v1, v4, v6, v5, v6}, Lkotlinx/coroutines/channels/vidar;->centurion(ILkotlinx/coroutines/channels/BufferOverflow;Lkotlin/jvm/functions/Function1;ILjava/lang/Object;)Lkotlinx/coroutines/channels/ceilometer;

    move-result-object v1

    .line 6
    new-instance v4, Landroidx/window/layout/disaffected;

    invoke-direct {v4, v1}, Landroidx/window/layout/disaffected;-><init>(Lkotlinx/coroutines/channels/ceilometer;)V
    ...
    invoke-static {v5}, Landroidx/window/layout/WindowInfoTrackerImpl;->dispirit(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/flocky;

    move-result-object v5

    iget-object v6, p0, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->$activity:Landroid/app/Activity;

    sget-object v7, Landroidx/privacysandbox/ads/adservices/adid/dispirit;->clergy:Landroidx/privacysandbox/ads/adservices/adid/dispirit;

    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/flocky;->poolside(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/centurion;)V
    ...
    invoke-interface {v1, v5}, Lkotlinx/coroutines/channels/ChannelIterator;->stylolite(Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    invoke-interface {v6, p1, v5}, Lkotlinx/coroutines/flow/deprecate;->emit(Ljava/lang/Object;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Landroidx/window/layout/WindowInfoTrackerImpl;->dispirit(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/flocky;

    move-result-object p1

    invoke-interface {p1, v4}, Landroidx/window/layout/flocky;->dispirit(Landroidx/core/util/centurion;)V
    ...
    invoke-static {v0}, Landroidx/window/layout/WindowInfoTrackerImpl;->dispirit(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/flocky;

    move-result-object v0

    invoke-interface {v0, v4}, Landroidx/window/layout/flocky;->dispirit(Landroidx/core/util/centurion;)V
