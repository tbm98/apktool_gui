...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->herbartianism(Ljava/nio/file/Path;Ljava/nio/file/Path;Lslouching/flocky;ZZ)Ljava/nio/file/Path;
.end annotation
...
.method public final invoke(Lkotlin/io/path/CopyActionContext;Ljava/nio/file/Path;Ljava/nio/file/Path;)Lkotlin/io/path/CopyActionResult;
    ...
    .line 2
    sget-object p1, Lkotlin/io/path/ceilometer;->poolside:Lkotlin/io/path/ceilometer;

    iget-boolean v0, p0, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2;->$followLinks:Z

    invoke-virtual {p1, v0}, Lkotlin/io/path/ceilometer;->poolside(Z)[Ljava/nio/file/LinkOption;
    ...
    .line 5
    invoke-static {p3}, Lkotlin/io/path/PathsKt__PathRecursiveFunctionsKt;->yesterdayness(Ljava/nio/file/Path;)V

    .line 6
    :cond_1
    new-instance v0, Lkotlin/jvm/internal/yesterdayness;

    const/4 v1, 0x2

    invoke-direct {v0, v1}, Lkotlin/jvm/internal/yesterdayness;-><init>(I)V

    invoke-virtual {v0, p1}, Lkotlin/jvm/internal/yesterdayness;->dispirit(Ljava/lang/Object;)V

    sget-object p1, Ljava/nio/file/StandardCopyOption;->REPLACE_EXISTING:Ljava/nio/file/StandardCopyOption;

    invoke-virtual {v0, p1}, Lkotlin/jvm/internal/yesterdayness;->poolside(Ljava/lang/Object;)V

    invoke-virtual {v0}, Lkotlin/jvm/internal/yesterdayness;->stylolite()I

    move-result p1

    new-array p1, p1, [Ljava/nio/file/CopyOption;

    invoke-virtual {v0, p1}, Lkotlin/jvm/internal/yesterdayness;->centurion([Ljava/lang/Object;)[Ljava/lang/Object;
