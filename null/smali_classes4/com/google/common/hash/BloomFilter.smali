...
# instance fields
.field private final bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;
...
# direct methods
.method private constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$poolside;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;
...
.method synthetic constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$poolside;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;Lcom/google/common/hash/BloomFilter$poolside;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$poolside;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V

    return-void
.end method

.method static synthetic access$000(Lcom/google/common/hash/BloomFilter;)Lcom/google/common/hash/BloomFilterStrategies$poolside;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;
...
.method static create(Lcom/google/common/hash/Funnel;JDLcom/google/common/hash/BloomFilter$Strategy;)Lcom/google/common/hash/BloomFilter;
    ...
    invoke-static {v2, v5, v3}, Lcom/google/common/base/fruitive;->decadent(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p3, p4}, Lcom/google/common/hash/BloomFilterStrategies$poolside;-><init>(J)V

    invoke-direct {p2, v0, p1, p0, p5}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$poolside;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    :try_end_0
...
.method public static readFrom(Ljava/io/InputStream;Lcom/google/common/hash/Funnel;)Lcom/google/common/hash/BloomFilter;
    ...
    invoke-static {v2}, Lcom/google/common/primitives/UnsignedBytes;->cryotherapy(B)I
    ...
    .line 8
    new-instance v4, Lcom/google/common/hash/BloomFilterStrategies$poolside;

    int-to-long v5, v0

    const-wide/16 v7, 0x40

    invoke-static {v5, v6, v7, v8}, Lcom/google/common/math/LongMath;->centurion(JJ)J

    move-result-wide v5

    invoke-direct {v4, v5, v6}, Lcom/google/common/hash/BloomFilterStrategies$poolside;-><init>(J)V
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->ceilometer(IJ)V
    ...
    invoke-direct {v1, v4, v2, p1, v3}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$poolside;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    :try_end_3
...
.method public approximateElementCount()J
    ...
    .line 1
    iget-object v0, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;

    invoke-virtual {v0}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->dispirit()J

    move-result-wide v0

    .line 2
    iget-object v2, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;

    invoke-virtual {v2}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->poolside()J
    ...
    .line 4
    invoke-static {v2, v3, v0}, Lcom/google/common/math/stylolite;->oxyphil(DLjava/math/RoundingMode;)J
...
.method public copy()Lcom/google/common/hash/BloomFilter;
    ...
    iget-object v1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;

    invoke-virtual {v1}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->stylolite()Lcom/google/common/hash/BloomFilterStrategies$poolside;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$poolside;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;

    .line 5
    invoke-virtual {v1, v3}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->equals(Ljava/lang/Object;)Z
...
.method public expectedFpp()D
    ...
    invoke-virtual {v0}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->poolside()J
...
.method public mightContain(Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;

    invoke-interface {v0, p1, v1, v2, v3}, Lcom/google/common/hash/BloomFilter$Strategy;->mightContain(Ljava/lang/Object;Lcom/google/common/hash/Funnel;ILcom/google/common/hash/BloomFilterStrategies$poolside;)Z
...
.method public put(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, p1, v1, v2, v3}, Lcom/google/common/hash/BloomFilter$Strategy;->put(Ljava/lang/Object;Lcom/google/common/hash/Funnel;ILcom/google/common/hash/BloomFilterStrategies$poolside;)Z
...
.method public putAll(Lcom/google/common/hash/BloomFilter;)V
    ...
    invoke-static {v4, v5, v2, v3}, Lcom/google/common/base/fruitive;->expiry(ZLjava/lang/String;II)V
    ...
    .line 7
    invoke-static/range {v7 .. v12}, Lcom/google/common/base/fruitive;->rabi(ZLjava/lang/String;JJ)V
    ...
    .line 10
    invoke-static {v0, v3, v1, v2}, Lcom/google/common/base/fruitive;->jesselton(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, p1, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;

    invoke-virtual {v0, p1}, Lcom/google/common/hash/BloomFilterStrategies$poolside;->deprecate(Lcom/google/common/hash/BloomFilterStrategies$poolside;)V
...
.method public writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-static {v1, v2}, Lcom/google/common/primitives/SignedBytes;->poolside(J)B
    ...
    invoke-static {v1, v2}, Lcom/google/common/primitives/UnsignedBytes;->poolside(J)B
    ...
    .line 4
    iget-object p1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$poolside;
    ...
    iget-object v1, v1, Lcom/google/common/hash/BloomFilterStrategies$poolside;->poolside:Ljava/util/concurrent/atomic/AtomicLongArray;
