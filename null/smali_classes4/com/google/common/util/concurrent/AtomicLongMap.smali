...
.method private poolside()Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    new-instance v1, Lcom/google/common/util/concurrent/AtomicLongMap$poolside;

    invoke-direct {v1, p0}, Lcom/google/common/util/concurrent/AtomicLongMap$poolside;-><init>(Lcom/google/common/util/concurrent/AtomicLongMap;)V

    .line 2
    invoke-static {v0, v1}, Lcom/google/common/collect/Maps;->ectostosis(Ljava/util/Map;Lcom/google/common/base/flocky;)Ljava/util/Map;
...
.method public asMap()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/common/util/concurrent/AtomicLongMap;->clergy:Ljava/util/Map;

    if-nez v0, :cond_0

    .line 2
    invoke-direct {p0}, Lcom/google/common/util/concurrent/AtomicLongMap;->poolside()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/util/concurrent/AtomicLongMap;->clergy:Ljava/util/Map;
