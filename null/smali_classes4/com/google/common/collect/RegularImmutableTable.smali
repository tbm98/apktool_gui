...
.method private static dispirit(Ljava/lang/Iterable;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
    .locals 5
    ...
    check-cast v3, Lcom/google/common/collect/acrobatic$poolside;

    .line 5
    invoke-interface {v3}, Lcom/google/common/collect/acrobatic$poolside;->getRowKey()Ljava/lang/Object;
    ...
    .line 6
    invoke-interface {v3}, Lcom/google/common/collect/acrobatic$poolside;->getColumnKey()Ljava/lang/Object;
...
.method static forCells(Ljava/lang/Iterable;)Lcom/google/common/collect/RegularImmutableTable;
    ...
    .line 5
    invoke-static {p0, v0, v0}, Lcom/google/common/collect/RegularImmutableTable;->dispirit(Ljava/lang/Iterable;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
...
.method static forCells(Ljava/util/List;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
    ...
    .line 2
    :cond_0
    new-instance v0, Lcom/google/common/collect/phylloclade;

    invoke-direct {v0, p1, p2}, Lcom/google/common/collect/phylloclade;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;)V
    ...
    .line 4
    :cond_1
    invoke-static {p0, p1, p2}, Lcom/google/common/collect/RegularImmutableTable;->dispirit(Ljava/lang/Iterable;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
...
.method public static synthetic poolside(Ljava/util/Comparator;Ljava/util/Comparator;Lcom/google/common/collect/acrobatic$poolside;Lcom/google/common/collect/acrobatic$poolside;)I
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/google/common/collect/RegularImmutableTable;->stylolite(Ljava/util/Comparator;Ljava/util/Comparator;Lcom/google/common/collect/acrobatic$poolside;Lcom/google/common/collect/acrobatic$poolside;)I
...
.method private static synthetic stylolite(Ljava/util/Comparator;Ljava/util/Comparator;Lcom/google/common/collect/acrobatic$poolside;Lcom/google/common/collect/acrobatic$poolside;)I
    .locals 3
    ...
    .line 1
    :cond_0
    invoke-interface {p2}, Lcom/google/common/collect/acrobatic$poolside;->getRowKey()Ljava/lang/Object;

    move-result-object v1

    invoke-interface {p3}, Lcom/google/common/collect/acrobatic$poolside;->getRowKey()Ljava/lang/Object;
    ...
    .line 2
    :cond_2
    invoke-interface {p2}, Lcom/google/common/collect/acrobatic$poolside;->getColumnKey()Ljava/lang/Object;

    move-result-object p0

    invoke-interface {p3}, Lcom/google/common/collect/acrobatic$poolside;->getColumnKey()Ljava/lang/Object;
...
.method final checkNoDuplicate(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 1
    invoke-static/range {v1 .. v6}, Lcom/google/common/base/fruitive;->orthograph(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method final createCellSet()Lcom/google/common/collect/ImmutableSet;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/RegularImmutableTable$CellSet;-><init>(Lcom/google/common/collect/RegularImmutableTable;Lcom/google/common/collect/RegularImmutableTable$poolside;)V
...
.method final createValues()Lcom/google/common/collect/ImmutableCollection;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/RegularImmutableTable$Values;-><init>(Lcom/google/common/collect/RegularImmutableTable;Lcom/google/common/collect/RegularImmutableTable$poolside;)V
...
.method abstract getCell(I)Lcom/google/common/collect/acrobatic$poolside;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
            "Lcom/google/common/collect/acrobatic$poolside<",
