...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/google/common/collect/MapMakerInternalMap$ceilometer;,
        Lcom/google/common/collect/MapMakerInternalMap$rabi;,
        Lcom/google/common/collect/MapMakerInternalMap$ecad;,
        Lcom/google/common/collect/MapMakerInternalMap$deprecate;,
        Lcom/google/common/collect/MapMakerInternalMap$metempirics;,
        Lcom/google/common/collect/MapMakerInternalMap$disaffected;,
        Lcom/google/common/collect/MapMakerInternalMap$fuzzball;,
        Lcom/google/common/collect/MapMakerInternalMap$homme;,
        Lcom/google/common/collect/MapMakerInternalMap$centurion;,
        ...
        Lcom/google/common/collect/MapMakerInternalMap$jesselton;,
...
.field static final UNSET_WEAK_VALUE_REFERENCE:Lcom/google/common/collect/MapMakerInternalMap$whydah;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/collect/MapMakerInternalMap$whydah<",
            "Ljava/lang/Object;",
...
.field final transient entryHelper:Lcom/google/common/collect/MapMakerInternalMap$wary;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/collect/MapMakerInternalMap$wary<",
            "TK;TV;TE;TS;>;"
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lcom/google/common/collect/MapMakerInternalMap$poolside;

    invoke-direct {v0}, Lcom/google/common/collect/MapMakerInternalMap$poolside;-><init>()V

    sput-object v0, Lcom/google/common/collect/MapMakerInternalMap;->UNSET_WEAK_VALUE_REFERENCE:Lcom/google/common/collect/MapMakerInternalMap$whydah;

    return-void
.end method

.method private constructor <init>(Lcom/google/common/collect/MapMaker;Lcom/google/common/collect/MapMakerInternalMap$wary;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p1}, Lcom/google/common/collect/MapMaker;->dispirit()I
    ...
    .line 3
    invoke-virtual {p1}, Lcom/google/common/collect/MapMaker;->centurion()Lcom/google/common/base/Equivalence;
    ...
    .line 4
    iput-object p2, p0, Lcom/google/common/collect/MapMakerInternalMap;->entryHelper:Lcom/google/common/collect/MapMakerInternalMap$wary;

    .line 5
    invoke-virtual {p1}, Lcom/google/common/collect/MapMaker;->stylolite()I
...
.method static synthetic access$900(Ljava/util/Collection;)Ljava/util/ArrayList;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/common/collect/MapMakerInternalMap;->poolside(Ljava/util/Collection;)Ljava/util/ArrayList;
...
.method static create(Lcom/google/common/collect/MapMaker;)Lcom/google/common/collect/MapMakerInternalMap;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/common/collect/MapMaker;->tori()Lcom/google/common/collect/MapMakerInternalMap$Strength;
    ...
    .line 2
    invoke-virtual {p0}, Lcom/google/common/collect/MapMaker;->deprecate()Lcom/google/common/collect/MapMakerInternalMap$Strength;
    ...
    invoke-static {}, Lcom/google/common/collect/MapMakerInternalMap$phagocyte$poolside;->homme()Lcom/google/common/collect/MapMakerInternalMap$phagocyte$poolside;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/MapMakerInternalMap;-><init>(Lcom/google/common/collect/MapMaker;Lcom/google/common/collect/MapMakerInternalMap$wary;)V
    ...
    invoke-static {}, Lcom/google/common/collect/MapMakerInternalMap$cryotherapy$poolside;->homme()Lcom/google/common/collect/MapMakerInternalMap$cryotherapy$poolside;
    ...
    invoke-static {}, Lcom/google/common/collect/MapMakerInternalMap$decadent$poolside;->homme()Lcom/google/common/collect/MapMakerInternalMap$decadent$poolside;
    ...
    invoke-static {}, Lcom/google/common/collect/MapMakerInternalMap$teltag$poolside;->homme()Lcom/google/common/collect/MapMakerInternalMap$teltag$poolside;
...
.method static createWithDummyValues(Lcom/google/common/collect/MapMaker;)Lcom/google/common/collect/MapMakerInternalMap;
    ...
    invoke-static {}, Lcom/google/common/collect/MapMakerInternalMap$flocky$poolside;->homme()Lcom/google/common/collect/MapMakerInternalMap$flocky$poolside;
    ...
    invoke-static {}, Lcom/google/common/collect/MapMakerInternalMap$dismission$poolside;->homme()Lcom/google/common/collect/MapMakerInternalMap$dismission$poolside;
...
.method private static poolside(Ljava/util/Collection;)Ljava/util/ArrayList;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method static unsetWeakValueReference()Lcom/google/common/collect/MapMakerInternalMap$whydah;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    sget-object v0, Lcom/google/common/collect/MapMakerInternalMap;->UNSET_WEAK_VALUE_REFERENCE:Lcom/google/common/collect/MapMakerInternalMap$whydah;
...
.method public containsValue(Ljava/lang/Object;)Z
    ...
    check-cast v14, Lcom/google/common/collect/MapMakerInternalMap$vidar;

    :goto_3
    if-eqz v14, :cond_2

    .line 7
    invoke-virtual {v11, v14}, Lcom/google/common/collect/MapMakerInternalMap$Segment;->getLiveValue(Lcom/google/common/collect/MapMakerInternalMap$vidar;)Ljava/lang/Object;
    ...
    .line 9
    :cond_1
    invoke-interface {v14}, Lcom/google/common/collect/MapMakerInternalMap$vidar;->getNext()Lcom/google/common/collect/MapMakerInternalMap$vidar;
...
.method copyEntry(Lcom/google/common/collect/MapMakerInternalMap$vidar;Lcom/google/common/collect/MapMakerInternalMap$vidar;)Lcom/google/common/collect/MapMakerInternalMap$vidar;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/common/collect/MapMakerInternalMap$Segment;->copyEntry(Lcom/google/common/collect/MapMakerInternalMap$vidar;Lcom/google/common/collect/MapMakerInternalMap$vidar;)Lcom/google/common/collect/MapMakerInternalMap$vidar;
...
.method createSegment(II)Lcom/google/common/collect/MapMakerInternalMap$Segment;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/common/collect/MapMakerInternalMap;->entryHelper:Lcom/google/common/collect/MapMakerInternalMap$wary;

    invoke-interface {v0, p0, p1, p2}, Lcom/google/common/collect/MapMakerInternalMap$wary;->deprecate(Lcom/google/common/collect/MapMakerInternalMap;II)Lcom/google/common/collect/MapMakerInternalMap$Segment;
...
.method public entrySet()Ljava/util/Set;
    ...
    .line 2
    :cond_0
    new-instance v0, Lcom/google/common/collect/MapMakerInternalMap$ceilometer;

    invoke-direct {v0, p0}, Lcom/google/common/collect/MapMakerInternalMap$ceilometer;-><init>(Lcom/google/common/collect/MapMakerInternalMap;)V
...
.method getEntry(Ljava/lang/Object;)Lcom/google/common/collect/MapMakerInternalMap$vidar;
    .locals 2
    .param p1    # Ljava/lang/Object;
        .annotation runtime Ljavax/annotation/CheckForNull;
        .end annotation
    ...
    invoke-virtual {v1, p1, v0}, Lcom/google/common/collect/MapMakerInternalMap$Segment;->getEntry(Ljava/lang/Object;I)Lcom/google/common/collect/MapMakerInternalMap$vidar;
...
.method isLiveForTesting(Lcom/google/common/collect/MapMakerInternalMap$vidar;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/collect/MapMakerInternalMap$Segment;->getLiveValueForTesting(Lcom/google/common/collect/MapMakerInternalMap$vidar;)Ljava/lang/Object;
...
.method public keySet()Ljava/util/Set;
    ...
    .line 2
    :cond_0
    new-instance v0, Lcom/google/common/collect/MapMakerInternalMap$ecad;

    invoke-direct {v0, p0}, Lcom/google/common/collect/MapMakerInternalMap$ecad;-><init>(Lcom/google/common/collect/MapMakerInternalMap;)V
...
.method keyStrength()Lcom/google/common/collect/MapMakerInternalMap$Strength;
    ...
    invoke-interface {v0}, Lcom/google/common/collect/MapMakerInternalMap$wary;->tori()Lcom/google/common/collect/MapMakerInternalMap$Strength;
...
.method reclaimKey(Lcom/google/common/collect/MapMakerInternalMap$vidar;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TE;)V"
    ...
    invoke-virtual {v1, p1, v0}, Lcom/google/common/collect/MapMakerInternalMap$Segment;->reclaimKey(Lcom/google/common/collect/MapMakerInternalMap$vidar;I)Z

    return-void
.end method

.method reclaimValue(Lcom/google/common/collect/MapMakerInternalMap$whydah;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-interface {p1}, Lcom/google/common/collect/MapMakerInternalMap$whydah;->poolside()Lcom/google/common/collect/MapMakerInternalMap$vidar;
    ...
    invoke-virtual {v2, v0, v1, p1}, Lcom/google/common/collect/MapMakerInternalMap$Segment;->reclaimValue(Ljava/lang/Object;ILcom/google/common/collect/MapMakerInternalMap$whydah;)Z
...
.method public size()I
    ...
    .line 4
    :cond_0
    invoke-static {v1, v2}, Lcom/google/common/primitives/Ints;->whydah(J)I
...
.method valueEquivalence()Lcom/google/common/base/Equivalence;
    ...
    invoke-interface {v0}, Lcom/google/common/collect/MapMakerInternalMap$wary;->dispirit()Lcom/google/common/collect/MapMakerInternalMap$Strength;
...
.method public values()Ljava/util/Collection;
    ...
    .line 2
    :cond_0
    new-instance v0, Lcom/google/common/collect/MapMakerInternalMap$rabi;

    invoke-direct {v0, p0}, Lcom/google/common/collect/MapMakerInternalMap$rabi;-><init>(Lcom/google/common/collect/MapMakerInternalMap;)V
