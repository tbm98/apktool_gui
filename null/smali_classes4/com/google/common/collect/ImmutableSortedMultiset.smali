...
.method private static centurion(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    check-cast v5, Lcom/google/common/collect/camisade$poolside;

    .line 6
    invoke-interface {v5}, Lcom/google/common/collect/camisade$poolside;->getElement()Ljava/lang/Object;

    move-result-object v6

    invoke-virtual {v0, v6}, Lcom/google/common/collect/ImmutableList$poolside;->wary(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$poolside;
    ...
    invoke-interface {v5}, Lcom/google/common/collect/camisade$poolside;->getCount()I
...
.method public static copyOf(Ljava/util/Comparator;Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-static {p0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset;->centurion(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    .line 13
    :cond_1
    new-instance v0, Lcom/google/common/collect/ImmutableSortedMultiset$poolside;

    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset$poolside;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {v0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset$poolside;->oxyphil(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSortedMultiset$poolside;
...
.method public static copyOf(Ljava/util/Comparator;Ljava/util/Iterator;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset$poolside;->disaffected(Ljava/util/Iterator;)Lcom/google/common/collect/ImmutableSortedMultiset$poolside;
...
.method public static copyOfSorted(Lcom/google/common/collect/posttyphoid;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 1
    invoke-interface {p0}, Lcom/google/common/collect/posttyphoid;->comparator()Ljava/util/Comparator;

    move-result-object v0

    invoke-interface {p0}, Lcom/google/common/collect/posttyphoid;->entrySet()Ljava/util/Set;
    ...
    .line 2
    invoke-static {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset;->centurion(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method public static naturalOrder()Lcom/google/common/collect/ImmutableSortedMultiset$poolside;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    invoke-direct {v0, v1}, Lcom/google/common/collect/ImmutableSortedMultiset$poolside;-><init>(Ljava/util/Comparator;)V
...
.method public static orderedBy(Ljava/util/Comparator;)Lcom/google/common/collect/ImmutableSortedMultiset$poolside;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static reverseOrder()Lcom/google/common/collect/ImmutableSortedMultiset$poolside;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
...
.method public bridge synthetic headMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Lcom/google/common/collect/posttyphoid;
    .locals 0
...
.method public final pollFirstEntry()Lcom/google/common/collect/camisade$poolside;
    .locals 1
...
.method public final pollLastEntry()Lcom/google/common/collect/camisade$poolside;
    .locals 1
    .annotation build Lcom/google/errorprone/annotations/poolside;
    .end annotation
...
.method public bridge synthetic tailMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Lcom/google/common/collect/posttyphoid;
    .locals 0
...
.method writeReplace()Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset$SerializedForm;-><init>(Lcom/google/common/collect/posttyphoid;)V
