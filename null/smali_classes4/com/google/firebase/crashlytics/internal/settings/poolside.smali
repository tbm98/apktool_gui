.class public Lcom/google/firebase/crashlytics/internal/settings/poolside;
.super Ljava/lang/Object;
.source "CachedSettingsIo.java"


# static fields
.field private static final dispirit:Ljava/lang/String; = "com.crashlytics.settings.json"
...
.method public constructor <init>(Lcom/google/firebase/crashlytics/internal/persistence/deprecate;)V
    ...
    .line 2
    invoke-virtual {p1, v0}, Lcom/google/firebase/crashlytics/internal/persistence/deprecate;->deprecate(Ljava/lang/String;)Ljava/io/File;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/crashlytics/internal/settings/poolside;->poolside:Ljava/io/File;

    return-void
.end method

.method private poolside()Ljava/io/File;
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/google/firebase/crashlytics/internal/settings/poolside;->poolside:Ljava/io/File;
...
# virtual methods
.method public dispirit()Lorg/json/JSONObject;
    .locals 6
    ...
    .line 2
    :try_start_0
    invoke-direct {p0}, Lcom/google/firebase/crashlytics/internal/settings/poolside;->poolside()Ljava/io/File;
    ...
    .line 5
    :try_start_1
    invoke-static {v3}, Lcom/google/firebase/crashlytics/internal/common/CommonUtils;->namer(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5, v2}, Lcom/google/firebase/crashlytics/internal/deprecate;->tori(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
...
.method public stylolite(JLorg/json/JSONObject;)V
    .locals 3
    ...
    .line 6
    invoke-static {p1, v0}, Lcom/google/firebase/crashlytics/internal/common/CommonUtils;->tori(Ljava/io/Closeable;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p3, p2}, Lcom/google/firebase/crashlytics/internal/deprecate;->tori(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
