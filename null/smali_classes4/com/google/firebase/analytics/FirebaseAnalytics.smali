...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/google/firebase/analytics/FirebaseAnalytics$stylolite;,
        Lcom/google/firebase/analytics/FirebaseAnalytics$dispirit;,
        Lcom/google/firebase/analytics/FirebaseAnalytics$poolside;
    }
.end annotation


# static fields
.field private static volatile stylolite:Lcom/google/firebase/analytics/FirebaseAnalytics;


# instance fields
.field private dispirit:Ljava/util/concurrent/ExecutorService;

.field private final poolside:Lcom/google/android/gms/internal/measurement/zzef;
...
.method public constructor <init>(Lcom/google/android/gms/internal/measurement/zzef;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->poolside:Lcom/google/android/gms/internal/measurement/zzef;

    return-void
.end method

.method private final ecad()Ljava/util/concurrent/ExecutorService;
    .locals 10
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->dispirit:Ljava/util/concurrent/ExecutorService;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/analytics/poolside;
    ...
    invoke-direct/range {v2 .. v9}, Lcom/google/firebase/analytics/poolside;-><init>(Lcom/google/firebase/analytics/FirebaseAnalytics;IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;)V

    iput-object v1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->dispirit:Ljava/util/concurrent/ExecutorService;
...
.method static bridge synthetic fuzzball(Lcom/google/firebase/analytics/FirebaseAnalytics;)Lcom/google/android/gms/internal/measurement/zzef;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->poolside:Lcom/google/android/gms/internal/measurement/zzef;
...
.method public static getInstance(Landroid/content/Context;)Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    .line 1
    sget-object v0, Lcom/google/firebase/analytics/FirebaseAnalytics;->stylolite:Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/analytics/FirebaseAnalytics;->stylolite:Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    sput-object v1, Lcom/google/firebase/analytics/FirebaseAnalytics;->stylolite:Lcom/google/firebase/analytics/FirebaseAnalytics;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->stylolite:Lcom/google/firebase/analytics/FirebaseAnalytics;
...
.method public static getScionFrontendApiImplementation(Landroid/content/Context;Landroid/os/Bundle;)Lcom/google/android/gms/measurement/internal/zzhy;
    ...
    :cond_0
    new-instance p1, Lcom/google/firebase/analytics/centurion;

    invoke-direct {p1, p0}, Lcom/google/firebase/analytics/centurion;-><init>(Lcom/google/android/gms/internal/measurement/zzef;)V
...
.method public ceilometer(Landroid/os/Bundle;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->poolside:Lcom/google/android/gms/internal/measurement/zzef;
...
.method public deprecate(Ljava/util/Map;)V
    .locals 6
    ...
    :cond_5
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->poolside:Lcom/google/android/gms/internal/measurement/zzef;
...
.method public dispirit()Lcom/google/android/gms/tasks/Task;
    .locals 7
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 1
    :try_start_0
    invoke-direct {p0}, Lcom/google/firebase/analytics/FirebaseAnalytics;->ecad()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    new-instance v1, Lcom/google/firebase/analytics/stylolite;

    invoke-direct {v1, p0}, Lcom/google/firebase/analytics/stylolite;-><init>(Lcom/google/firebase/analytics/FirebaseAnalytics;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/analytics/FirebaseAnalytics;->poolside:Lcom/google/android/gms/internal/measurement/zzef;
...
.method public getFirebaseInstanceId()Ljava/lang/String;
    ...
    .line 1
    :try_start_0
    invoke-static {}, Lcom/google/firebase/installations/wary;->decadent()Lcom/google/firebase/installations/wary;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/firebase/installations/wary;->getId()Lcom/google/android/gms/tasks/Task;
...
.method public poolside()Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v1, Lcom/google/firebase/analytics/dispirit;

    invoke-direct {v1, p0}, Lcom/google/firebase/analytics/dispirit;-><init>(Lcom/google/firebase/analytics/FirebaseAnalytics;)V
...
.method public stylolite(Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 1
