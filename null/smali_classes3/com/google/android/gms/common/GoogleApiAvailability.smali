...
.method final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 8
    new-instance v6, Landroidx/core/app/NotificationCompat$flocky;

    invoke-direct {v6, p1}, Landroidx/core/app/NotificationCompat$flocky;-><init>(Landroid/content/Context;)V

    .line 9
    invoke-virtual {v6, v3}, Landroidx/core/app/NotificationCompat$flocky;->pfda(Z)Landroidx/core/app/NotificationCompat$flocky;

    move-result-object v6

    .line 10
    invoke-virtual {v6, v3}, Landroidx/core/app/NotificationCompat$flocky;->canaliform(Z)Landroidx/core/app/NotificationCompat$flocky;

    move-result-object v6

    .line 11
    invoke-virtual {v6, v0}, Landroidx/core/app/NotificationCompat$flocky;->uppiled(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$flocky;

    move-result-object v0

    new-instance v6, Landroidx/core/app/NotificationCompat$ecad;

    invoke-direct {v6}, Landroidx/core/app/NotificationCompat$ecad;-><init>()V

    .line 12
    invoke-virtual {v6, v1}, Landroidx/core/app/NotificationCompat$ecad;->orthograph(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$ecad;

    move-result-object v6

    invoke-virtual {v0, v6}, Landroidx/core/app/NotificationCompat$flocky;->overwhelming(Landroidx/core/app/NotificationCompat$jesselton;)Landroidx/core/app/NotificationCompat$flocky;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/NotificationCompat$flocky;->analcite(I)Landroidx/core/app/NotificationCompat$flocky;

    move-result-object v1

    .line 16
    invoke-virtual {v1, p3}, Landroidx/core/app/NotificationCompat$flocky;->heroise(I)Landroidx/core/app/NotificationCompat$flocky;
    ...
    .line 20
    invoke-virtual {v0, v1, v4, p4}, Landroidx/core/app/NotificationCompat$flocky;->poolside(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$flocky;

    goto :goto_0

    .line 21
    :cond_2
    invoke-virtual {v0, p4}, Landroidx/core/app/NotificationCompat$flocky;->nutant(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$flocky;
    ...
    .line 22
    invoke-virtual {v0, v6}, Landroidx/core/app/NotificationCompat$flocky;->analcite(I)Landroidx/core/app/NotificationCompat$flocky;
    ...
    invoke-virtual {v6, v4}, Landroidx/core/app/NotificationCompat$flocky;->ectostosis(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$flocky;
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/core/app/NotificationCompat$flocky;->whiz(J)Landroidx/core/app/NotificationCompat$flocky;

    move-result-object v4

    .line 25
    invoke-virtual {v4, p4}, Landroidx/core/app/NotificationCompat$flocky;->nutant(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$flocky;

    move-result-object p4

    .line 26
    invoke-virtual {p4, v1}, Landroidx/core/app/NotificationCompat$flocky;->gypper(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$flocky;
    ...
    :cond_6
    :goto_1
    invoke-virtual {v0, v1}, Landroidx/core/app/NotificationCompat$flocky;->credulity(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$flocky;
