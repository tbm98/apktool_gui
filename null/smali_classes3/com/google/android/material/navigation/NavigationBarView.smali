...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/google/android/material/navigation/NavigationBarView$stylolite;,
        Lcom/google/android/material/navigation/NavigationBarView$centurion;,
        Lcom/google/android/material/navigation/NavigationBarView$dispirit;
    }
.end annotation
...
.field private final menu:Lcom/google/android/material/navigation/poolside;
...
.field private reselectedListener:Lcom/google/android/material/navigation/NavigationBarView$stylolite;

.field private selectedListener:Lcom/google/android/material/navigation/NavigationBarView$centurion;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 1
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/material/theme/overlay/poolside;->stylolite(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    .line 4
    sget-object v2, Ldelusion/poolside$phagocyte;->NavigationBarView:[I

    const/4 v0, 0x2

    new-array v5, v0, [I

    sget v7, Ldelusion/poolside$phagocyte;->NavigationBarView_itemTextAppearanceInactive:I

    const/4 v8, 0x0

    aput v7, v5, v8

    sget v9, Ldelusion/poolside$phagocyte;->NavigationBarView_itemTextAppearanceActive:I
    ...
    .line 5
    invoke-static/range {v0 .. v5}, Lcom/google/android/material/internal/phagocyte;->fuzzball(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroidx/appcompat/widget/utilizable;

    move-result-object p2

    .line 6
    new-instance p3, Lcom/google/android/material/navigation/poolside;
    ...
    invoke-direct {p3, v6, p4, v0}, Lcom/google/android/material/navigation/poolside;-><init>(Landroid/content/Context;Ljava/lang/Class;I)V

    iput-object p3, p0, Lcom/google/android/material/navigation/NavigationBarView;->menu:Lcom/google/android/material/navigation/poolside;
    ...
    .line 8
    invoke-virtual {p1, p4}, Lcom/google/android/material/navigation/NavigationBarPresenter;->dispirit(Lcom/google/android/material/navigation/NavigationBarMenuView;)V

    .line 9
    invoke-virtual {p1, v10}, Lcom/google/android/material/navigation/NavigationBarPresenter;->poolside(I)V
    ...
    .line 11
    invoke-virtual {p3, p1}, Landroidx/appcompat/view/menu/tori;->dispirit(Landroidx/appcompat/view/menu/ecad;)V
    ...
    invoke-virtual {p1, v0, p3}, Lcom/google/android/material/navigation/NavigationBarPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/tori;)V

    .line 13
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemIconTint:I
    ...
    .line 14
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/utilizable;->centurion(I)Landroid/content/res/ColorStateList;
    ...
    .line 16
    invoke-virtual {p4, p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->centurion(I)Landroid/content/res/ColorStateList;
    ...
    .line 18
    :goto_0
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemIconSize:I
    ...
    sget v1, Ldelusion/poolside$deprecate;->mtrl_navigation_bar_item_default_icon_size:I
    ...
    .line 21
    invoke-virtual {p2, p1, v0}, Landroidx/appcompat/widget/utilizable;->ceilometer(II)I
    ...
    .line 23
    invoke-virtual {p2, v7}, Landroidx/appcompat/widget/utilizable;->scotomization(I)Z
    ...
    .line 24
    invoke-virtual {p2, v7, v8}, Landroidx/appcompat/widget/utilizable;->decadent(II)I
    ...
    .line 26
    :cond_1
    invoke-virtual {p2, v9}, Landroidx/appcompat/widget/utilizable;->scotomization(I)Z
    ...
    .line 27
    invoke-virtual {p2, v9, v8}, Landroidx/appcompat/widget/utilizable;->decadent(II)I
    ...
    .line 29
    :cond_2
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemTextColor:I
    ...
    .line 32
    :cond_4
    invoke-direct {p0, v6}, Lcom/google/android/material/navigation/NavigationBarView;->createMaterialShapeDrawableBackground(Landroid/content/Context;)Lcom/google/android/material/shape/wary;
    ...
    .line 33
    :cond_5
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemPaddingTop:I
    ...
    .line 34
    invoke-virtual {p2, p1, v8}, Landroidx/appcompat/widget/utilizable;->ceilometer(II)I
    ...
    .line 36
    :cond_6
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemPaddingBottom:I
    ...
    .line 39
    :cond_7
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_elevation:I
    ...
    .line 41
    :cond_8
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_backgroundTint:I

    .line 42
    invoke-static {v6, p2, p1}, Lcom/google/android/material/resources/stylolite;->dispirit(Landroid/content/Context;Landroidx/appcompat/widget/utilizable;I)Landroid/content/res/ColorStateList;
    ...
    .line 44
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_labelVisibilityMode:I

    const/4 v0, -0x1

    .line 45
    invoke-virtual {p2, p1, v0}, Landroidx/appcompat/widget/utilizable;->cryotherapy(II)I
    ...
    .line 47
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemBackground:I

    invoke-virtual {p2, p1, v8}, Landroidx/appcompat/widget/utilizable;->decadent(II)I
    ...
    .line 49
    :cond_9
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemRippleColor:I
    ...
    .line 52
    :goto_1
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_itemActiveIndicatorStyle:I
    ...
    .line 55
    sget-object v0, Ldelusion/poolside$phagocyte;->NavigationBarActiveIndicator:[I
    ...
    .line 57
    sget v0, Ldelusion/poolside$phagocyte;->NavigationBarActiveIndicator_android_width:I
    ...
    .line 60
    sget v0, Ldelusion/poolside$phagocyte;->NavigationBarActiveIndicator_android_height:I
    ...
    .line 63
    sget v0, Ldelusion/poolside$phagocyte;->NavigationBarActiveIndicator_marginHorizontal:I
    ...
    .line 66
    sget v0, Ldelusion/poolside$phagocyte;->NavigationBarActiveIndicator_android_color:I

    .line 67
    invoke-static {v6, p1, v0}, Lcom/google/android/material/resources/stylolite;->poolside(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 69
    sget v0, Ldelusion/poolside$phagocyte;->NavigationBarActiveIndicator_shapeAppearance:I
    ...
    .line 71
    invoke-static {v6, v0, v8}, Lcom/google/android/material/shape/phagocyte;->dispirit(Landroid/content/Context;II)Lcom/google/android/material/shape/phagocyte$dispirit;
    ...
    .line 72
    invoke-virtual {p0, v0}, Lcom/google/android/material/navigation/NavigationBarView;->setItemActiveIndicatorShapeAppearance(Lcom/google/android/material/shape/phagocyte;)V
    ...
    .line 74
    :cond_a
    sget p1, Ldelusion/poolside$phagocyte;->NavigationBarView_menu:I
    ...
    .line 78
    new-instance p1, Lcom/google/android/material/navigation/NavigationBarView$poolside;

    invoke-direct {p1, p0}, Lcom/google/android/material/navigation/NavigationBarView$poolside;-><init>(Lcom/google/android/material/navigation/NavigationBarView;)V

    invoke-virtual {p3, p1}, Landroidx/appcompat/view/menu/tori;->mississippian(Landroidx/appcompat/view/menu/tori$poolside;)V

    return-void
.end method

.method static synthetic access$000(Lcom/google/android/material/navigation/NavigationBarView;)Lcom/google/android/material/navigation/NavigationBarView$stylolite;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/google/android/material/navigation/NavigationBarView;->reselectedListener:Lcom/google/android/material/navigation/NavigationBarView$stylolite;

    return-object p0
.end method

.method static synthetic access$100(Lcom/google/android/material/navigation/NavigationBarView;)Lcom/google/android/material/navigation/NavigationBarView$centurion;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/google/android/material/navigation/NavigationBarView;->selectedListener:Lcom/google/android/material/navigation/NavigationBarView$centurion;

    return-object p0
.end method

.method private createMaterialShapeDrawableBackground(Landroid/content/Context;)Lcom/google/android/material/shape/wary;
    .locals 3
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 7
    :cond_0
    invoke-virtual {v0, p1}, Lcom/google/android/material/shape/wary;->esquamate(Landroid/content/Context;)V
...
.method public getBadge(I)Lcom/google/android/material/badge/poolside;
    .locals 1
    .annotation build Landroidx/annotation/gypper;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->homme(I)Lcom/google/android/material/badge/poolside;
...
.method public getItemActiveIndicatorShapeAppearance()Lcom/google/android/material/shape/phagocyte;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/navigation/NavigationBarMenuView;->getItemActiveIndicatorShapeAppearance()Lcom/google/android/material/shape/phagocyte;
...
.method public getMenu()Landroid/view/Menu;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/navigation/NavigationBarView;->menu:Lcom/google/android/material/navigation/poolside;

    return-object v0
.end method

.method public getMenuView()Landroidx/appcompat/view/menu/expiry;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public getOrCreateBadge(I)Lcom/google/android/material/badge/poolside;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->vidar(I)Lcom/google/android/material/badge/poolside;
...
.method public inflateMenu(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/material/navigation/NavigationBarPresenter;->stylolite(Z)V
    ...
    iget-object v2, p0, Lcom/google/android/material/navigation/NavigationBarView;->menu:Lcom/google/android/material/navigation/poolside;
    ...
    invoke-virtual {p1, v0}, Lcom/google/android/material/navigation/NavigationBarPresenter;->stylolite(Z)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object p1, p1, Lcom/google/android/material/navigation/NavigationBarView$SavedState;->plumper:Landroid/os/Bundle;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Lcom/google/android/material/navigation/NavigationBarView$SavedState;->plumper:Landroid/os/Bundle;
...
.method public removeBadge(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->expiry(I)V
...
.method public setItemActiveIndicatorShapeAppearance(Lcom/google/android/material/shape/phagocyte;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/navigation/NavigationBarMenuView;->setItemActiveIndicatorShapeAppearance(Lcom/google/android/material/shape/phagocyte;)V
...
.method public setItemRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    .line 6
    :cond_2
    invoke-static {p1}, Lcom/google/android/material/ripple/dispirit;->poolside(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public setOnItemReselectedListener(Lcom/google/android/material/navigation/NavigationBarView$stylolite;)V
    .locals 0
    .param p1    # Lcom/google/android/material/navigation/NavigationBarView$stylolite;
        .annotation build Landroidx/annotation/gypper;
        .end annotation
    .end param

    .line 1
    iput-object p1, p0, Lcom/google/android/material/navigation/NavigationBarView;->reselectedListener:Lcom/google/android/material/navigation/NavigationBarView$stylolite;

    return-void
.end method

.method public setOnItemSelectedListener(Lcom/google/android/material/navigation/NavigationBarView$centurion;)V
    .locals 0
    .param p1    # Lcom/google/android/material/navigation/NavigationBarView$centurion;
        .annotation build Landroidx/annotation/gypper;
        .end annotation
    .end param

    .line 1
    iput-object p1, p0, Lcom/google/android/material/navigation/NavigationBarView;->selectedListener:Lcom/google/android/material/navigation/NavigationBarView$centurion;
...
.method public setSelectedItemId(I)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroidx/appcompat/view/menu/tori;->uppiled(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/ecad;I)Z
