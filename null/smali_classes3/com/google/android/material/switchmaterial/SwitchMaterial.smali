...
# instance fields
.field private final elevationOverlayProvider:Lcom/google/android/material/elevation/poolside;
...
.method static constructor <clinit>()V
    ...
    .line 1
    sget v0, Ldelusion/poolside$flocky;->Widget_MaterialComponents_CompoundButton_Switch:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, Ldelusion/poolside$stylolite;->switchStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    new-instance p1, Lcom/google/android/material/elevation/poolside;

    invoke-direct {p1, v0}, Lcom/google/android/material/elevation/poolside;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/google/android/material/switchmaterial/SwitchMaterial;->elevationOverlayProvider:Lcom/google/android/material/elevation/poolside;

    .line 6
    sget-object v2, Ldelusion/poolside$phagocyte;->SwitchMaterial:[I
    ...
    .line 8
    sget p3, Ldelusion/poolside$phagocyte;->SwitchMaterial_useMaterialThemeColors:I
...
.method private getMaterialThemeColorsThumbTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v0}, Lcom/google/android/material/color/expiry;->centurion(Landroid/view/View;I)I

    move-result v0

    .line 3
    sget v1, Ldelusion/poolside$stylolite;->colorControlActivated:I

    invoke-static {p0, v1}, Lcom/google/android/material/color/expiry;->centurion(Landroid/view/View;I)I
    ...
    sget v3, Ldelusion/poolside$deprecate;->mtrl_switch_thumb_elevation:I
    ...
    .line 5
    iget-object v3, p0, Lcom/google/android/material/switchmaterial/SwitchMaterial;->elevationOverlayProvider:Lcom/google/android/material/elevation/poolside;

    invoke-virtual {v3}, Lcom/google/android/material/elevation/poolside;->ecad()Z
    ...
    .line 8
    invoke-virtual {v3, v0, v2}, Lcom/google/android/material/elevation/poolside;->tori(IF)I
    ...
    .line 10
    invoke-static {v0, v1, v6}, Lcom/google/android/material/color/expiry;->expiry(IIF)I
...
.method private getMaterialThemeColorsTrackTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v2}, Lcom/google/android/material/color/expiry;->centurion(Landroid/view/View;I)I

    move-result v2

    .line 4
    sget v3, Ldelusion/poolside$stylolite;->colorControlActivated:I

    invoke-static {p0, v3}, Lcom/google/android/material/color/expiry;->centurion(Landroid/view/View;I)I

    move-result v3

    .line 5
    sget v4, Ldelusion/poolside$stylolite;->colorOnSurface:I

    invoke-static {p0, v4}, Lcom/google/android/material/color/expiry;->centurion(Landroid/view/View;I)I
    ...
    .line 6
    invoke-static {v2, v3, v6}, Lcom/google/android/material/color/expiry;->expiry(IIF)I
    ...
    .line 7
    invoke-static {v2, v4, v6}, Lcom/google/android/material/color/expiry;->expiry(IIF)I
