...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    sget v0, Ldelusion/poolside$stylolite;->autoCompleteTextViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    sget-object v3, Ldelusion/poolside$phagocyte;->MaterialAutoCompleteTextView:[I

    sget v5, Ldelusion/poolside$flocky;->Widget_AppCompat_AutoCompleteTextView:I
    ...
    .line 8
    sget p3, Ldelusion/poolside$phagocyte;->MaterialAutoCompleteTextView_android_inputType:I
    ...
    .line 11
    :cond_0
    sget p3, Ldelusion/poolside$phagocyte;->MaterialAutoCompleteTextView_simpleItemLayout:I

    sget v1, Ldelusion/poolside$fuzzball;->mtrl_auto_complete_simple_item:I
    ...
    .line 14
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/ListPopupWindow;->cingalese(Z)V

    .line 15
    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/ListPopupWindow;->yesterdayness(Landroid/view/View;)V

    const/4 p1, 0x2

    .line 16
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/ListPopupWindow;->esquamate(I)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/ListPopupWindow;->flocky(Landroid/widget/ListAdapter;)V

    .line 18
    new-instance p1, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView$poolside;

    invoke-direct {p1, p0}, Lcom/google/android/material/textfield/MaterialAutoCompleteTextView$poolside;-><init>(Lcom/google/android/material/textfield/MaterialAutoCompleteTextView;)V

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/ListPopupWindow;->pfda(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 19
    sget p1, Ldelusion/poolside$phagocyte;->MaterialAutoCompleteTextView_simpleItems:I
...
.method private measureContentWidth()I
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/ListPopupWindow;->canaliform()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/ListPopupWindow;->ceilometer()Landroid/graphics/drawable/Drawable;
...
.method protected onAttachedToWindow()V
    ...
    .line 5
    invoke-static {}, Lcom/google/android/material/internal/ceilometer;->stylolite()Z
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ListPopupWindow;->flocky(Landroid/widget/ListAdapter;)V
