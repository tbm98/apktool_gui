.class Lcom/google/common/base/fuzzball$poolside;
...
# static fields
.field private static final poolside:Ljava/lang/String; = "Could not load Finalizer in its own class loader. Loading Finalizer in the current class loader instead. As a result, you will not be able to garbage collect this class loader. To support reclaiming this class loader, either resolve the underlying issue, or move Guava to your system class path."
...
.method public poolside()Ljava/lang/Class;
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0}, Lcom/google/common/base/fuzzball$poolside;->dispirit()Ljava/net/URL;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/common/base/fuzzball$poolside;->stylolite(Ljava/net/URL;)Ljava/net/URLClassLoader;
    ...
    .line 3
    invoke-static {}, Lcom/google/common/base/fuzzball;->poolside()Ljava/util/logging/Logger;
...
.method stylolite(Ljava/net/URL;)Ljava/net/URLClassLoader;
    .locals 3
