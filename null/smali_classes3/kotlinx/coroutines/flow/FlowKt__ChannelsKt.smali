...
# direct methods
.method public static final ceilometer(Lkotlinx/coroutines/channels/ReceiveChannel;)Lkotlinx/coroutines/flow/tori;
    .locals 9
...
.method public static final centurion(Lkotlinx/coroutines/flow/deprecate;Lkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    .locals 1
    ...
    .line 1
    invoke-static {p0, p1, v0, p2}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt;->tori(Lkotlinx/coroutines/flow/deprecate;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/stylolite;)Ljava/lang/Object;
...
.method public static final deprecate(Lkotlinx/coroutines/flow/tori;Lkotlinx/coroutines/gypper;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 0
    ...
    .line 1
    invoke-static {p0}, Lkotlinx/coroutines/flow/internal/centurion;->dispirit(Lkotlinx/coroutines/flow/tori;)Lkotlinx/coroutines/flow/internal/ChannelFlow;

    move-result-object p0

    invoke-virtual {p0, p1}, Lkotlinx/coroutines/flow/internal/ChannelFlow;->phagocyte(Lkotlinx/coroutines/gypper;)Lkotlinx/coroutines/channels/ReceiveChannel;
...
.method public static final dispirit(Lkotlinx/coroutines/channels/centurion;)Lkotlinx/coroutines/flow/tori;
    .locals 1
    ...
    .line 1
    new-instance v0, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt$poolside;

    invoke-direct {v0, p0}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt$poolside;-><init>(Lkotlinx/coroutines/channels/centurion;)V

    return-object v0
.end method

.method public static final synthetic poolside(Lkotlinx/coroutines/flow/deprecate;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/stylolite;)Ljava/lang/Object;
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt;->tori(Lkotlinx/coroutines/flow/deprecate;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/stylolite;)Ljava/lang/Object;
...
.method public static final stylolite(Lkotlinx/coroutines/channels/ReceiveChannel;)Lkotlinx/coroutines/flow/tori;
    .locals 9
    .param p0    # Lkotlinx/coroutines/channels/ReceiveChannel;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method private static final tori(Lkotlinx/coroutines/flow/deprecate;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/stylolite;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p3}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt$emitAllImpl$1;-><init>(Lkotlin/coroutines/stylolite;)V
    ...
    .line 2
    invoke-static {p0}, Lkotlinx/coroutines/flow/ceilometer;->clergy(Lkotlinx/coroutines/flow/deprecate;)V
    ...
    invoke-interface {p3, v0}, Lkotlinx/coroutines/channels/ChannelIterator;->stylolite(Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    invoke-interface {v2, p3, v0}, Lkotlinx/coroutines/flow/deprecate;->emit(Ljava/lang/Object;Lkotlin/coroutines/stylolite;)Ljava/lang/Object;
    ...
    .line 5
    invoke-static {p1, v5}, Lkotlinx/coroutines/channels/ecad;->dispirit(Lkotlinx/coroutines/channels/ReceiveChannel;Ljava/lang/Throwable;)V
