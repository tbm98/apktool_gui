...
.method public static AFKeystoreWrapper(Ljava/lang/String;)I
    ...
    .line 2
    invoke-interface {p0}, Lkotlin/text/MatchResult;->centurion()Lkotlin/text/deprecate;

    move-result-object v0

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Lkotlin/text/deprecate;->get(I)Lkotlin/text/MatchGroup;
    ...
    invoke-virtual {v0}, Lkotlin/text/MatchGroup;->deprecate()Ljava/lang/String;
    ...
    invoke-interface {v2, v3}, Lkotlin/text/deprecate;->get(I)Lkotlin/text/MatchGroup;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lkotlin/text/MatchGroup;->deprecate()Ljava/lang/String;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-static {v2}, Lkotlin/text/vidar;->hijaz(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-interface {p0, v2}, Lkotlin/text/deprecate;->get(I)Lkotlin/text/MatchGroup;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-virtual {p0}, Lkotlin/text/MatchGroup;->deprecate()Ljava/lang/String;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-static {p0}, Lkotlin/text/vidar;->hijaz(Ljava/lang/String;)Ljava/lang/Integer;
