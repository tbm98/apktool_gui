...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/bumptech/glide/load/engine/GlideException$poolside;
    }
.end annotation


# static fields
.field private static final clergy:[Ljava/lang/StackTraceElement;
...
.field private key:Lcom/bumptech/glide/load/stylolite;
...
.method static constructor <clinit>()V
    ...
    .line 1
    sput-object v0, Lcom/bumptech/glide/load/engine/GlideException;->clergy:[Ljava/lang/StackTraceElement;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 5
    sget-object p1, Lcom/bumptech/glide/load/engine/GlideException;->clergy:[Ljava/lang/StackTraceElement;
...
.method private static centurion(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
    .locals 1
...
.method private static dispirit(Ljava/util/List;Ljava/lang/Appendable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    :try_start_0
    invoke-static {p0, p1}, Lcom/bumptech/glide/load/engine/GlideException;->stylolite(Ljava/util/List;Ljava/lang/Appendable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private poolside(Ljava/lang/Throwable;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-direct {p0, v0, p2}, Lcom/bumptech/glide/load/engine/GlideException;->poolside(Ljava/lang/Throwable;Ljava/util/List;)V
...
.method private static stylolite(Ljava/util/List;Ljava/lang/Appendable;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    invoke-direct {v1, p1}, Lcom/bumptech/glide/load/engine/GlideException;->tori(Ljava/lang/Appendable;)V

    goto :goto_1

    .line 11
    :cond_0
    invoke-static {v1, p1}, Lcom/bumptech/glide/load/engine/GlideException;->centurion(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
...
.method private tori(Ljava/lang/Appendable;)V
    .locals 2

    .line 1
    invoke-static {p0, p1}, Lcom/bumptech/glide/load/engine/GlideException;->centurion(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
    ...
    new-instance v1, Lcom/bumptech/glide/load/engine/GlideException$poolside;

    invoke-direct {v1, p1}, Lcom/bumptech/glide/load/engine/GlideException$poolside;-><init>(Ljava/lang/Appendable;)V

    invoke-static {v0, v1}, Lcom/bumptech/glide/load/engine/GlideException;->dispirit(Ljava/util/List;Ljava/lang/Appendable;)V
...
.method public getMessage()Ljava/lang/String;
    ...
    .line 5
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/GlideException;->key:Lcom/bumptech/glide/load/stylolite;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/GlideException;->key:Lcom/bumptech/glide/load/stylolite;
...
.method public getRootCauses()Ljava/util/List;
    ...
    .line 2
    invoke-direct {p0, p0, v0}, Lcom/bumptech/glide/load/engine/GlideException;->poolside(Ljava/lang/Throwable;Ljava/util/List;)V
...
.method public printStackTrace(Ljava/io/PrintStream;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/engine/GlideException;->tori(Ljava/lang/Appendable;)V
...
.method setLoggingDetails(Lcom/bumptech/glide/load/stylolite;Lcom/bumptech/glide/load/DataSource;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-virtual {p0, p1, p2, v0}, Lcom/bumptech/glide/load/engine/GlideException;->setLoggingDetails(Lcom/bumptech/glide/load/stylolite;Lcom/bumptech/glide/load/DataSource;Ljava/lang/Class;)V

    return-void
.end method

.method setLoggingDetails(Lcom/bumptech/glide/load/stylolite;Lcom/bumptech/glide/load/DataSource;Ljava/lang/Class;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/GlideException;->key:Lcom/bumptech/glide/load/stylolite;
